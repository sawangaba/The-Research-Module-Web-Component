...
$sql= "select * from document where work_email='{$_SESSION['work_email']}'";

$query=$conn->query("select * from sign_up where work_email='{$_SESSION['work_email']}'");
...
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.22/pdfmake.min.js"></script>
    ...
    <div id="print" style=" align-content:center;">
        <br>
        <h2 style="text-align:center; color: rgb(99,97,97);background-color: rgb(255,255,25:);"><strong>Report of documents uploded by <?php echo $result2["prefix"]." ".$result2["full_name"]?></strong></h2><br>
...
<div class="controls" style="text-align:center; height:80%;">
     <button style="margin: 0 auto;" onclick="saveAsExcel('table2excel', 'report.xls')">Convert to Excel</button>&nbsp;&nbsp;<button style="margin: 0 auto;" id="pdf" onclick="Export()">Convert to PDF</button>&nbsp;&nbsp;<a href="dy_re.html"><button style="margin: 0 auto;">Back</button></a>
    </div>
