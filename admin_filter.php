...
$_SESSION['filter']="select * from document ORDER BY upload_date DESC";
...
if($approved==0 && $pending ==0 && $sort_name==1){
    ...
    $_SESSION['filter']="select * from document ORDER BY full_jName ASC";
    ...
    $_SESSION['filter']="select * from document where approved=1 ORDER BY upload_date DESC";
    
}
else if($approved==0 && $pending ==1 && $sort_date==1){
    
    $_SESSION['filter']="select * from document where approved=0 ORDER BY upload_date DESC";
    
}
else if($approved==1 && $pending ==0 && $sort_name==1){
    
    $_SESSION['filter']="select * from document where approved=1 ORDER BY full_jName ASC";
    
}
else if($approved==0 && $pending ==1 && $sort_name==1){
    
    $_SESSION['filter']="select * from document where approved=0 ORDER BY full_jName ASC";
    ...
    $_SESSION['filter']="select * from document where approved=1";
    
}
else if($approved==0 && $pending ==1){
    
    $_SESSION['filter']="select * from document where approved=0";
